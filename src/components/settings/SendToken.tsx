...
import { CHAIN_NUMBER_POLYGON, MATIC_SYMBOL, GLOBAL_MAX_CHARACTER_NUMBER } from "../../constants/constants";
                        ...
                        >
                            ...
                            { selectedToken === tokenSymbol &&
                                <TextField
                                    ...
                                    error={ (!!tokenAmount && Number(tokenAmount) === 0) || (chainId === CHAIN_NUMBER_POLYGON ? (!!tokenBalance && !!tokenAmount && ethers.BigNumber.from(tokenBalance).lt(ethers.utils.parseUnits(tokenAmount, 6))) : (!!tokenBalance && !!tokenAmount && ethers.BigNumber.from(tokenBalance).lt(ethers.utils.parseEther(tokenAmount)))) }
                                    helperText={ (!!tokenAmount && Number(tokenAmount) === 0) && ERROR_ZERO_AMOUNT || (chainId === CHAIN_NUMBER_POLYGON ? (!!tokenBalance && !!tokenAmount && ethers.BigNumber.from(tokenBalance).lt(ethers.utils.parseUnits(tokenAmount, 6))) : (!!tokenBalance && !!tokenAmount && ethers.BigNumber.from(tokenBalance).lt(ethers.utils.parseEther(tokenAmount)))) && INSUFFICIENT_BALANCE }
                                // disabled={  }
                                />
                            }
                            ...
                            <Box>
                                ...
                                <StandardButton
                                    ...
                                    disabled={
                                        ...
                                        || (tokenBalance && tokenAmount && (chainId === CHAIN_NUMBER_POLYGON ? (ethers.BigNumber.from(tokenBalance).lt(ethers.utils.parseUnits(tokenAmount, 6))) : (ethers.BigNumber.from(tokenBalance).lt(ethers.utils.parseEther(tokenAmount)))))
