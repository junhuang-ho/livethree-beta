...
import { StandardButton } from '../../components/styled';
import { DialogHasNetFlow } from '../../components/dialogs/DialogHasNetFlow';

import { PERCENTAGE_TAKE_NUMERATOR, PERCENTAGE_TAKE_NUMERATOR_PROMO1, CALL_HISTORY_LIMIT, PLACEHOLDER_ADDRESS } from '../../constants/constants';

import { ButtonAcceptIncomingCall } from '../../components/buttons/ButtonAcceptIncomingCall'
